    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a1525]/90 backdrop-blur-xl border-b border-[#1d3458] transition-all duration-300">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a
            href="/cyberrunner.html"
            className="hidden md:flex items-center gap-2 px-3 py-2 rounded-lg border border-[#fde047]/40 text-[#fde047] text-xs font-mono font-semibold hover:bg-[#fde047]/10 hover:border-[#fde047] transition-all no-underline"
            title="Play Cyberrunner"
          >
